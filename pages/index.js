      ...
      <footer className="text-center lg:text-left bg-gradient-to-t from-purple-400 to-cyan-50 text-black">
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            <Link href="#!" passHref><a className=" px-2">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="">
              ...
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">Angular</a></Link>
              </div>
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">React</a></Link>
              </div>
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">Vue</a></Link>
              </div>
              <div>
                <Link href="#!"><a className="no-underline text-black">Laravel</a></Link>
              </div>
            </div>
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center">
              ...
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">Notice</a></Link>
              </div>
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">Brochure</a></Link>
              </div>
              <div className="mb-4">
                <Link href="#!"><a className="no-underline text-black">Career</a></Link>
              </div>
              <div>
                <Link href="#!"><a className="no-underline text-black">Results</a></Link>
              </div>
            </div>
            <div className="">
              ...
              <div className="flex items-center justify-center md:justify-start mb-4">
                ...
                Kanubari, Arunachal Pradesh 792130, INDIA
              </div>
              <div className="flex items-center justify-center md:justify-start mb-4">
